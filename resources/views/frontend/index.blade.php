                                    ...
                                    <a href="{{route('frontend.product_details' , $row->slug)}}">
                                        <div class="trends_item is_new">
                                            ...
                                            <div class="trends_content ">
                                                <div class="trends_info clearfix text-center">
                                                    <h4 class="text-center">{{ substr($row->name, 0, 10) }}</h4>
                                ...
                                <a href="{{route('frontend.product_details', $row->slug)}}">
                                        <div
                                            ...
                                            <div class="viewed_content text-center">
                                                <div class="product_price discount" style="margin-top: 10px">
                                                    @if ($row->discount_price)
                                                        <h5 style="font-size:18px;color:red">{{ $settings->currency }}{{ $row->discount_price }}</h5>
                                                        <del>{{ $settings->currency }}{{ $row->selling_price }}</del>
                                                    @else
                                                        <div>{{ $row->discount_price }}</div>
                                                    @endif
